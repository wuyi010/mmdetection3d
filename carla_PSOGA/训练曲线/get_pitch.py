...
LiDAR_F = df['LiDAR-F-PITCH'] *0.017453292519943295
LIDAR_FR = df['LIDAR_FR_PITCH'] *0.017453292519943295
LIDAR_BR = df['LIDAR_BR_PITCH']*0.017453292519943295

CAM_I_FR = df['CAM-I-FR-PITCH']*0.017453292519943295
CAM_I_BR = df['CAM-I-BR-PITCH']*0.017453292519943295
CAM_II_FR = df['CAM-II-FR-PITCH'] *0.017453292519943295 # 15 0.2617993877991494
