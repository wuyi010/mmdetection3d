...
LiDAR_F= df['LiDAR-F-Z']
LIDAR_FR = df['LIDAR_FR_Z']
LIDAR_BR = df['LIDAR_BR_Z']

CAM_I_FR = df['CAM-I-FR-Z']
CAM_I_BR = df['CAM-I-BR-Z']
CAM_II_FR = df['CAM-II-FR-Z']
...
plt.ylabel('Z-axis / m', fontsize=16, fontweight='normal')
