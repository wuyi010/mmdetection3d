...
LiDAR_F= df['LiDAR-F-YAW']*0.017453292519943295
LIDAR_FR = df['LIDAR_FR_YAW']*0.017453292519943295
LIDAR_BR = df['LIDAR_BR_YAW']*0.017453292519943295

CAM_I_FR = df['CAM-I-FR-YAW']*0.017453292519943295
CAM_I_BR = df['CAM-I-BR-YAW']*0.017453292519943295
CAM_II_FR = df['CAM-II-FR-YAW']  *0.017453292519943295
