...
LiDAR_F= df['LiDAR-F-X']
LIDAR_FR = df['LIDAR_FR_X']
LIDAR_BR = df['LIDAR_BR_X']

CAM_I_FR = df['CAM-I-FR-X']
CAM_I_BR = df['CAM-I-BR-X']
CAM_II_FR = df['CAM-II-FR-X']
...
plt.ylabel('X-axis / m', fontsize=16, fontweight='normal')
