...
to_rad = 1
CAM_I_FR =     df['CAM_I_FR_Z'] * to_rad
CAM_I_BR =     df['CAM_I_BR_Z'] * to_rad
CAM_II =         df['CAM_II_Z'] * to_rad
LIDAR_I_FR = df['LIDAR_I_FR_Z'] * to_rad
LIDAR_I_BR = df['LIDAR_I_BR_Z'] * to_rad
LIDAR_II_R = df['LIDAR_II_R_Z'] * to_rad
LIDAR_II_F = df['LIDAR_II_F_Z'] * to_rad
RADAR_FR =     df['RADAR_FR_Z'] * to_rad
RADAR_BR =     df['RADAR_BR_Z'] * to_rad
RADAR_F =       df['RADAR_F_Z'] * to_rad
# 设置绘图风格
...
plt.ylabel('Z-axis / mm', fontsize=16, fontweight='normal')
